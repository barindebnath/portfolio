      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 mt-10">
            {/* Bio */}
            <div>
              <h2 className="font-display font-bold text-[clamp(2rem,4vw,3rem)] leading-tight text-text mb-6">
            ...
            <div className="space-y-6">
              {skillGroups.map(({ category, skills }) => (
                <div key={category}>
                  <p className="text-xs font-display font-semibold uppercase tracking-widest text-muted/80 mb-3">
                    {category}
                  </p>
